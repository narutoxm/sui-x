...
impl ObjectCacheRead for WritebackCache {
    fn get_package_object(&self, package_id: &ObjectID) -> SuiResult<Option<PackageObject>> {
        ...
        if let Some(p) = self.packages.get(package_id) {
            ...
            self.metrics
                .record_cache_miss("package", "package_cache", Some(&package_id));
        }
    ...
    fn find_object_lt_or_eq_version(
        ...
        self.metrics
            .record_cache_miss("object_lt_or_eq_version", "object_by_id", Some(&object_id));
    ...
    fn notify_read_input_objects<'a>(
        ...
        self.object_notify_read
            .read("notify_read_input_objects", input_and_receiving_keys, move |keys| {
